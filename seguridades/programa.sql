...
INSERT INTO `banners` VALUES (1,'Estreno - Kong La Isla Calavera','2017-07-27','slide1.jpg','Activo'),(2,'Proximo Mes - La bella y la bestia','2017-07-27','slide2.jpg','Activo'),(3,'Ya esta aquí - Spider Man, de regreso a casa','2017-07-28','slide3.jpg','Activo'),(4,'Por fin ha llegado el día - Cars 3 ','2017-07-29','slide4.jpg','Activo'),(5,'Star Wars: Episodio VIII - Los ultimos Jedi.','2017-11-17','slide5.jpg','Activo');
...
INSERT INTO `peliculas` VALUES (1,'Kong La Isla Calavera',118,'B','Accion y Aventura','kong.png','2018-01-07','Activa',1),(2,'Life: Vida Inteligente',104,'B','Drama','life.png','2018-01-07','Activa',2),(3,'La Bella y La Bestia',132,'A','Infantil','bella.png','2018-01-07','Activa',3),(4,'Contratiempo',106,'B','Thriller','contratiempo.png','2018-01-09','Activa',4),(5,'Power Rangers',120,'B','Aventura','power-rangers.png','2018-01-09','Activa',5),(7,'Rapidos y Furiosos 8',136,'B','Accion','rapidos-furiosos.png','2018-01-11','Activa',6),(8,'Guardianes de la Galaxia Vol 2',136,'B','Accion','guardianes-galaxia.png','2018-01-11','Activa',7);
...
INSERT INTO `usuarios` VALUES (1,'Luis (Editor de My CineSite)','editor@cinesite.com','luis','$2a$10$AETWiBpAoJQkho0/8XWfredrElkH8CrSXFSD9yUHbik924VUlKWB6',1),(2,'Marisol (Gerente de My CineSite)','gerente@cinesite.com','marisol','$2a$10$5Z8LcbSeBZYWR29jzL1Ku.e0q.2DMacqLGVFuP7OroxL/9I9HJLh6',1);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'programa'
--

--
-- Dumping routines for database 'programa'
--
...
-- Dump completed on 2018-10-10 17:17:36
